...
y también carguemos la base de datos que utilizaremos, que corresponde a un subset de la ESI (Encuesta Sumplementaria de Ingresos) (https://www.ine.gob.cl/estadisticas/sociales/ingresos-y-gastos/encuesta-suplementaria-de-ingresos) para ocupados:
...
1.  Qué es una distribución muestral.
2.  Qué es el error estándar.
3.  Qué son y cómo calcular intervalos de confianza.

# Reporte de progreso

Completar el reporte de progreso correspondiente a esta práctica [disponible próximamente aquí](). El plazo para contestarlo es hasta el día viernes de la semana en la que se publica la práctica correspondiente.
