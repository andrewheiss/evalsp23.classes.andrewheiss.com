...
Con el primer código no obtuvimos información sustantiva, pero con el segundo sí al remover los `NA` solo de dicha variable para un cálculo determinado.
...
- La información de cada coeficiente se repite sobre y bajo la diagonal, ya que es el mismo par de variables pero en el orden alterno. Podemos omitir los pares de información que se repiten o son redundantes.
