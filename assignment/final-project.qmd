...
This project is due by **11:59 PM on Monday, May 1, 2023.** <span style="color: #81056F; font-weight: bold"> No late work will be accepted.</span>

I will grade your project using this rubric. I *highly* recommend that you refer to the rubric as you work on your project!

- {{< fa list-check >}}&ensp;[`evalsp23_final-project-rubric.xlsx`](/files/evalsp23_final-project-rubric.xlsx)
...
- [{{< fa arrow-up-right-from-square >}} Empty Posit.cloud project](https://posit.cloud/spaces/323551/content/5774783)
