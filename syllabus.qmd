...
En este curso vamos a aprender dos cosas principales:
...
Para ello, un par de ideas transversales:

- vamos a _partir por el final_: la asociación entre variables busca representar asociación entre conceptos, lo que está a la base de distintas teorías, tales como la sociológicas. Por ello, comenzaremos desde acá, reflexionando sobre asociaciones y su medición, poniendo como un ejemplo el coeficiente de correlación. Luego en la segunda unidad vamos a profundizar en temas de inferencia estadística, y al final volveremos a medidas de asociación para variables categórias y otras extensiones.

- vamos a dar énfasis a la _comunicación de los resultados_: nuestros análisis se reflejan en productos como tablas y gráficos. No basta con entenderlos e interpretarlos, sino también es fundamental una buena comunicación. Acá es pertinente considerar temas estéticos y de orden, pero también plataformas y dispositivos de reporte y comunicación. 
